...
public class Student extends Person{
	...
	//A constructor with the stu_id, gpa and grade as arguments.
		public Student(String stu_id, double gpa, String grade) {
			this.stu_id = stu_id;
			this.gpa = gpa;
			this.grade = grade;
		}
...
//This class defines the teacher class and it is a sub class.
...
public class Teacher extends Person{
	...
	public Teacher(String id, int salary, int num_yr_prof) {
		this.id = id;
		this.salary = salary;
...
public class Lab4 {
	...
	public static void main(String[] args) {
		...
		//Creating new Student and Teacher object.
		Student s1  = new Student("43321",4.0,"A");
		Teacher t1 = new Teacher("23",50000,5);
		
		//Calling the setPersonSsn from the Super Class on the s1 and t1 object.
		s1.setPersonSsn("33-44-222");
		t1.setPersonSsn("83-11-421");
		
		//The s1 object calling a toString method from the student class and the t1 object calling the toString method from its Teacher class.
		System.out.println(s1.toString());
		System.out.println(t1.toString());
		System.out.println("Student1 SSN: " + s1.getPersonSsn());
		System.out.println("Teacher1 SSN: " + t1.getPersonSsn());
